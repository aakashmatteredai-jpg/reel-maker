...
import { DEFAULT_TRANSCRIPT_ELEMENT } from "@/constants/text-constants";
...
export function TranscribeButton() {
	...
	const handleTranscribe = async () => {
		...
		try {
			...
			// Auto-add transcript track if not present
			const tracks = editor.timeline.getTracks();
			if (!tracks.some((t) => t.type === "transcript")) {
				const trackId = editor.timeline.addTrack({ type: "transcript" });
				editor.timeline.insertElement({
					element: {
						...DEFAULT_TRANSCRIPT_ELEMENT,
